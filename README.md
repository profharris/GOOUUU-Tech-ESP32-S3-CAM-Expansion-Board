...
|                        |  ___   _   __¯|    G##~ SD_Card ¦   64×128    ¦ SDA > G8  |
 ...
 Pinout:   G   G       E     G             G          5 G G G G G G 3 G G G G G ×
           2   3       N     0             1          V N 1 2 4 4 0 V N 4 1 2 4
                                                      0 D 4 1 7 5   3 D 2     1 '-IRQ
                                                                    |   | | | '-MISO
——————————————————————————————————————————————————————————————————— |   | | '-MOSI
QUICK NOTE: This GOOUUU Tech ESP32-S3-CAM Expansion Board has TWO   |   | '-CS  Touch
——————————— sets of header-pin sockets (Yellow and Black) to plug   |   '-SCK    Pins
            in your ESP32-S3-WROOM-1 Development boards.            |
                                                                    |
            The 40-Pin “Yellow” header sockets, are designed for    '-BackLight
...
GOOUUU Tech ESP32-S3-CAM Expansion Board
 ...
 •     Header S3:
 •     Header S4:
 •       I²C SDA: GPIO8         [0.96″ OLED]
 •       I²C SCL: GPIO9         [  64×128  ]
 •        LED D1: GPIO1
 •        LED D2: GPIO2
 •        LED D3: GPIO3
 •  [RST] Button: EN/RESET
