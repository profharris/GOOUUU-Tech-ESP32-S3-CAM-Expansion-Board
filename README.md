...
<pre><code>
———————————————————————————————————————————————————————————————————————
ESP32-S3-WROOM Camera Interface  (OV2640)
——————————————————————————————— 
 Uses _ALL_ but *3* IO pins on the   *ESP32-S3-WROOM-1*   *Camera Interface*
 Left-side of ESP32-S3-WROOM-1   _(Left Side Pins)_   _(FPC 0.5mm 24P)_
                                  1.     3V3         1. NC      ×
